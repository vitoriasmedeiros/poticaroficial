...
<html>
  ...
  <body >
    <header><a href="paginaprincipaladm.php">POTICAR</a></header>
    ...
    ?>
        <div class="box">
          ...
          <div class="box-btn">
              <a class="btn-i" type="button" href="atualizarcarro.php?idCarro=<?php echo "$idCarro"; ?>">Atualizar</a>
              <a class="btn-i" type="button" href="enviardeletarcarro.php?idCarro=<?php echo "$idCarro"; ?>">Deletar</a>
          </div>
        </div>
        <?php  }  ?><!--fechar while-->
    </main>    
